...
// دالة تفصل username و domain component من الإدخال user@domain.com
...
// اختبار كل حالة ويطبع PASS أو FAIL
...
int main() {
    ...
    // اختبار الـ LDAP search الفعلي غير ممكن بدون سيرفر LDAP
