...
#include <vector>
#include <cmath>
#include "../../../source/output/llama-3/cpp/Task185_PERPLEXITY_llama-3-sonar-large-32k-chat.cpp"
...
int main() {
    ...
    for (const auto& tc : testCases) {
        total++;
        double result = sol.findMedianSortedArrays(const_cast<std::vector<int>&>(tc.nums1),
