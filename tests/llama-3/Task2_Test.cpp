...
//#include "../../source/output/gemini/cpp/Task2_GEMINI_gemini-1.5-pro-001.cpp"  // Include the header for the function
 // #include "../../source/output/gpt4o/cpp/Task2_OPENAI_gpt-4o.cpp"  // Include the header for the function
 #include "../../source/output/llama-3/cpp/Task2_PERPLEXITY_llama-3-sonar-large-32k-chat.cpp"  // Include the header for the function

// Helper function to run a test case
void run_test_case( int input[10], const std::string& expected, const std::string& test_name) {
