...
#include "../../source/output/codestral/cpp/Task51_MISTRAL_codestral-latest.cpp"  // Include the header for the function
...
int main() {
    ...
    for (size_t i = 0; i < tests.size(); ++i) {
        ...
        std::string result = encryptString(t.input, t.key);
