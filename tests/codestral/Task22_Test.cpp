...
void testMixedList() {
    ...
    std::vector<boost::variant<int, std::string>> input = {1, 2, "a", "b"};
...
void testEmptyList() {
    ...
    std::vector<boost::variant<int, std::string>> input = {};
...
void testAllStrings() {
    ...
    std::vector<boost::variant<int, std::string>> input = {"a", "b", "c"};
    std::vector<int> expected = {};
    assert(filter_list(input) == expected);
...
void testAllIntegers() {
    ...
    std::vector<boost::variant<int, std::string>> input = {1, 2, 3, 4};
...
void testStringsAndIntegersMixed() {
    ...
    std::vector<boost::variant<int, std::string>> input = {1, "a", 2, "b", 0, 15};
...
void testSingleElementInteger() {
    ...
    std::vector<boost::variant<int, std::string>> input = {5};
...
void testSingleElementString() {
    ...
    std::vector<boost::variant<int, std::string>> input = {"onlyString"};
    std::vector<int> expected = {};
    assert(filter_list(input) == expected);
...
void testIntegersAndNumericStrings() {
    ...
    std::vector<boost::variant<int, std::string>> input = {1, "2", "three", 4, "5"};
