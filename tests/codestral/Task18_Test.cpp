...
void testbinaryArrayToNumber() {
    // assert(binaryArrayToNumber({0, 0, 0, 1}) == 1); // 0001 = 1 //failed
    // assert(binaryArrayToNumber({0, 0, 1, 0}) == 2); // 0010 = 2 //failed
    // assert(binaryArrayToNumber({0, 1, 0, 1}) == 5); // 0101 = 5 //failed
    ...
    // assert(binaryArrayToNumber({1, 0, 1, 1}) == 11); // 1011 = 11 //failed
    assert(binaryArrayToNumber({1}) == 1); // Single bit 1
    assert(binaryArrayToNumber({0}) == 0); // Single bit 0
    // assert(binaryArrayToNumber({0, 1, 0, 1, 0, 1, 1}) == 43); // 0101011 = 43  //failed
