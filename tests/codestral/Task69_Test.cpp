#include "../../source/output/codestral/cpp/Task69_MISTRAL_codestral-latest.cpp"
...
void test_1_delete_existing_file() {
    ...
    ASSERT_TRUE(!std::filesystem::exists(filename) &&
                output.find("has been deleted") != std::string::npos,
...
void test_2_delete_non_existing_file() {
    ...
    ASSERT_TRUE(output.find("does not exist") != std::string::npos,
