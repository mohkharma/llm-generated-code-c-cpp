...
void testNumbering() {
    ...
    assert(Solution::number(input5) == expected5);
    ...
    assert(Solution::number(input8) == expected8);
    ...
    assert(Solution::number(input9) == expected9);
    ...
    assert(Solution::number(input10) == expected10);
