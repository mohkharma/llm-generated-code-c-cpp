...
// The solution function exactly as given:
...
// Helper to join vector<string> to a single string with commas (for error messages)
...
// Runs a single test, compares expected and actual vectors strictly
...
int main() {
    // Define all test cases exactly as in the Python unittest (only those with expected outputs)
    struct TestCase {
