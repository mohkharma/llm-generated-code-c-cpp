#include "../../source/output/gpt4o/cpp/Task65_OPENAI_gpt-4o.cpp"  // Include the header for the function
...
int main() {
    ...
    // test_2_file_not_exist
    {
        ...
        validateAndPrintFileContent("nonexistent.txt");

        std::cout.rdbuf(oldCout);
        std::string output = buffer.str();
        bool ok = output.find("File does not exist") != std::string::npos;
    ...
    // test_3_valid_file_read
    {
        ...
        validateAndPrintFileContent(filename);
