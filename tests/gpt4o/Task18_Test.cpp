...
void testbinaryArrayToInt() {
    assert(binaryArrayToInt({0, 0, 0, 1}) == 1); // 0001 = 1
    assert(binaryArrayToInt({0, 0, 1, 0}) == 2); // 0010 = 2
    assert(binaryArrayToInt({0, 1, 0, 1}) == 5); // 0101 = 5
    assert(binaryArrayToInt({1, 0, 0, 1}) == 9); // 1001 = 9
    assert(binaryArrayToInt({0, 1, 1, 0}) == 6); // 0110 = 6
    assert(binaryArrayToInt({1, 1, 1, 1}) == 15); // 1111 = 15
    assert(binaryArrayToInt({1, 0, 1, 1}) == 11); // 1011 = 11
    assert(binaryArrayToInt({1}) == 1); // Single bit 1
    assert(binaryArrayToInt({0}) == 0); // Single bit 0
    assert(binaryArrayToInt({0, 1, 0, 1, 0, 1, 1}) == 43); // 0101011 = 43
