...
int main() {
    ...
    runTest("Test Case 5", productOfNumbers.getProduct(3), 192); // 6 * 8 * 4 = 192
    ...
    productOfNumbers.add(4);
    productOfNumbers.add(5);
    runTest("Test Case 9", productOfNumbers.getProduct(3), 60);  // 3 * 4 * 5

    productOfNumbers.add(0);
    runTest("Test Case 10", productOfNumbers.getProduct(2), 0);  // 0 * 5
