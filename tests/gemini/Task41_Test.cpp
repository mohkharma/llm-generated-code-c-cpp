...
#include "../../source/output/gemini/cpp/Task41_GEMINI_gemini-1.5-pro-001.cpp"  // Include the header for the function
...
void run_test(const std::string& test_name, const std::string& simulated_input, const std::string& expected_output) {
    ...
    readAndPrintInput();  // الدالة من الحل
