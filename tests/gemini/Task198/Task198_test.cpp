...
#include "../../../source/output/gemini/cpp/Task198_GEMINI_gemini-1.5-pro-001.cpp"
...
int main() {
    ...
    // 4. Performance test (reduced size)
    {
        std::cout << "▶️ Running Performance Test..." << std::endl;
        int n = 100000;  // Reduced from 1,000,000
